...
class _ExchangeRateRepository implements ExchangeRateRepository {
  _ExchangeRateRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ExchangeRate> getRate({
    ...
    final _options = _setStreamType<ExchangeRate>(
    ...
    late ExchangeRate _value;
    try {
      _value = ExchangeRate.fromJson(_result.data!);
    } on Object catch (e, s) {
